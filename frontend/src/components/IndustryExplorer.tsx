...
export function IndustryExplorer({ onNavigate, onViewCompany, onLogout, initialViewMode = 'sectors' }: IndustryExplorerProps) {
  ...
  const sectors = [
    { id: 'Energy', name: 'Energy', count: 13, growth: '+5%', icon: Zap },
    { id: 'Banking & Financial Services', name: 'Banking & Financial Services', count: 10, growth: '+15%', icon: DollarSign },
    { id: 'Cement', name: 'Cement', count: 8, growth: '+12%', icon: Layers },
    { id: 'Textile & Apparel', name: 'Textile & Apparel', count: 7, growth: '+8%', icon: Leaf },
    { id: 'Chemicals & Fertilizers', name: 'Chemicals & Fertilizers', count: 6, growth: '+10%', icon: Building2 },
    { id: 'Automotive', name: 'Automotive', count: 5, growth: '-2%', icon: Building2 },
    { id: 'Food & Agriculture', name: 'Food & Agriculture', count: 4, growth: '+6%', icon: Leaf },
    { id: 'Pharmaceuticals', name: 'Pharmaceuticals', count: 4, growth: '+18%', icon: Building2 },
    { id: 'Insurance', name: 'Insurance', count: 4, growth: '+12%', icon: DollarSign },
    { id: 'Steel & Materials', name: 'Steel & Materials', count: 3, growth: '+4%', icon: Layers },
    { id: 'Telecom', name: 'Telecom', count: 3, growth: '+3%', icon: Server },
    { id: 'Technology', name: 'Technology', count: 3, growth: '+24%', icon: Server },
    { id: 'Paper & Board', name: 'Paper & Board', count: 2, growth: '+5%', icon: Layers },
    { id: 'Cable & Electrical Goods', name: 'Cable & Electrical Goods', count: 2, growth: '+7%', icon: Building2 },
    { id: 'Sugar', name: 'Sugar', count: 2, growth: '+3%', icon: Leaf },
    ...
    { id: 'Tobacco', name: 'Tobacco', count: 1, growth: '+2%', icon: Building2 },
  ];
